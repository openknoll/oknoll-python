...
| `packages/oknoll-cli` | `oknoll` Typer CLI (frozen command surface, design §5.1) |
...
oknoll add https://github.com/tungamajunga/openknoll       # commit-SHA provenance
...
Branches: feature branches off `develop`; `main` is promotion-only (see ADR-0001).
