"""The seven deterministic explorer tools (design §7.2).
...
Bundle text is untrusted data (design §7.3): nothing here follows external
...
# otherwise the body cap above is a paper wall (design §7.2: bounded outputs).
...
class Explorer:
    """Deterministic navigation over one bundle tree (design §7.2)."""
