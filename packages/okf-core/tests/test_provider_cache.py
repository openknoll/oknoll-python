"""Model provider stub determinism and build-cache behavior (design §5.4)."""

from pathlib import Path

import pytest
from okf_core import BuildCache, StubModelProvider, generation_cache_key, resolve_provider
